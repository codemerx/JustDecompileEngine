...
{
    class StackVariableInliningStep : BaseVariableInliningStep
    {
        ...
        public StackVariableInliningStep(MethodSpecificContext methodContext, Dictionary<int, Expression> offsetToExpression)
            : base(methodContext, new SimpleVariableInliner(methodContext.Method.Module.TypeSystem))
        {
